...
module.exports.run = async function({ api, event, args }) {
    try {
        ...
        const url = `https://joshweb.click/canvas/fbcoverv2?name=${encodeURIComponent(name)}&id=${encodeURIComponent(id)}&subname=${encodeURIComponent(subname)}&color=${encodeURIComponent(color)}`;
